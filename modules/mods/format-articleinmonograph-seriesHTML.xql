    ...
    if ($config:DEBUG) then
        ...
        (),
            ...
            if (exists ($entry/mods:relatedItem[@type="series"]/mods:titleInfo/@transliteration)) then
                    (
                <span lang="en">({tei2fo:process-biblioHTML($entry/mods:relatedItem[@type="series"]/mods:titleInfo[(@transliteration)]/mods:title)}{$settings:SPACE}</span>,
                <span lang="zh">{tei2fo:process-biblioHTML($entry/mods:relatedItem[@type="series"]/mods:titleInfo[@lang = ("zh", "ja", "ko")]/mods:title)}<span lang="en">{if (exists($entry/mods:relatedItem/mods:part/mods:detail/mods:number)) then <span> {$entry/mods:relatedItem/mods:part/mods:detail/mods:number/text()}</span> else ()}{if (exists($entry/mods:relatedItem/mods:titleInfo/@displayLabel)) then <span>{$settings:SPACE}[{$entry/mods:relatedItem/mods:titleInfo[@type="translated"]/mods:title/text()}]</span> else ()}).</span></span>
                    )
                
            else
                    (  
                <span lang="en">({tei2fo:process-biblioHTML($entry/mods:relatedItem[@type="series"]/mods:titleInfo[@lang = ("de", "en", "fr")]/mods:title)}{if ($entry/mods:relatedItem[@type="series"]//mods:number/text())then <span>{$settings:SPACE}{$entry/mods:relatedItem[@type="series"]//mods:number/text()}</span> else () }).</span>
                     ),
    ...
    if ($config:DEBUG) then
        ...
        (),
            ...
            if (exists ($entry/mods:relatedItem[@type="series"]/mods:titleInfo/@transliteration)) then
                    (
                <span lang="en">{tei2fo:process-biblioHTML($entry/mods:relatedItem[@type="series"]/mods:titleInfo[(@transliteration)]/mods:title)}{$settings:SPACE}</span>,
                <span lang="zh">{tei2fo:process-biblioHTML($entry/mods:relatedItem[@type="series"]/mods:titleInfo[@lang = ("zh", "ja", "ko")]/mods:title)}.</span>
                    )
                
            else
                    (  
                <span lang="en">({tei2fo:process-biblioHTML($entry/mods:relatedItem[@type="series"]/mods:titleInfo[@lang = ("de", "en", "fr")]/mods:title)}{if ($entry/mods:relatedItem[@type="series"]//mods:number/text())then <span>{$entry/mods:relatedItem[@type="series"]//mods:number/text()}{$settings:SPACE}</span> else () }).</span>
                     ),
                publisherHTML:output-publisherHTML($entry),
                dateHTML:output-dateHTML($entry),
                "."
